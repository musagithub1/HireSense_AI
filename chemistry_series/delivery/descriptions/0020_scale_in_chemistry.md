...
This short chemistry explainer answers: **How does scale in chemistry work?**

Scale in chemistry becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand scale in chemistry by linking structure to observable behavior.
