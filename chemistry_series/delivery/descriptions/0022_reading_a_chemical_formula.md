...
This short chemistry explainer answers: **How does reading a chemical formula work?**

Reading a chemical formula becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand reading a chemical formula by linking structure to observable behavior.
