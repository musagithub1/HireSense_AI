...
This short chemistry explainer answers: **How does temperature scales work?**

Temperature scales becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand temperature scales by linking structure to observable behavior.
