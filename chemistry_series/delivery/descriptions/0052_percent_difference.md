...
This short chemistry explainer answers: **How does percent difference work?**

Percent difference becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand percent difference by linking structure to observable behavior.
