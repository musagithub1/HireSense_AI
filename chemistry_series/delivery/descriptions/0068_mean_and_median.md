...
This short chemistry explainer answers: **How does mean and median work?**

Mean and median becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand mean and median by linking structure to observable behavior.
