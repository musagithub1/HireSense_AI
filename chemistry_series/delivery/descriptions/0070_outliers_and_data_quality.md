...
This short chemistry explainer answers: **How does outliers and data quality work?**

Outliers and data quality becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand outliers and data quality by linking structure to observable behavior.
