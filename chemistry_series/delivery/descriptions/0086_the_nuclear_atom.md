...
This short chemistry explainer answers: **How does the nuclear atom work?**

The nuclear atom becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand the nuclear atom by linking structure to observable behavior.
