...
This short chemistry explainer answers: **How does isotopes work?**

Isotopes becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand isotopes by linking structure to observable behavior.
