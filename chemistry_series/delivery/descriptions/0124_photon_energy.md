...
This short chemistry explainer answers: **How does photon energy work?**

Photon energy becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand photon energy by linking structure to observable behavior.
