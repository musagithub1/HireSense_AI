...
This short chemistry explainer answers: **How does quantum numbers work?**

Quantum numbers becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand quantum numbers by linking structure to observable behavior.
