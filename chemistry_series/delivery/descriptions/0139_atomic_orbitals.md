...
This short chemistry explainer answers: **How does atomic orbitals work?**

Atomic orbitals becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand atomic orbitals by linking structure to observable behavior.
