...
This short chemistry explainer answers: **How does p orbitals work?**

p orbitals becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand p orbitals by linking structure to observable behavior.
