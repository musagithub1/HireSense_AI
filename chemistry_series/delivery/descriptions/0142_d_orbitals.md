...
This short chemistry explainer answers: **How does d orbitals work?**

d orbitals becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand d orbitals by linking structure to observable behavior.
