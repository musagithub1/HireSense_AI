...
This short chemistry explainer answers: **How does f orbitals work?**

f orbitals becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand f orbitals by linking structure to observable behavior.
