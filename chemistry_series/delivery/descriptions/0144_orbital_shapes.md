...
This short chemistry explainer answers: **How does orbital shapes work?**

Orbital shapes becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand orbital shapes by linking structure to observable behavior.
