...
This short chemistry explainer answers: **How does nodes in orbitals work?**

Nodes in orbitals becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand nodes in orbitals by linking structure to observable behavior.
