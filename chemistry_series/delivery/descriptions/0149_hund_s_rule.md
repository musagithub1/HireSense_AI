...
This short chemistry explainer answers: **How does hund's rule work?**

Hund's rule becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand hund's rule by linking structure to observable behavior.
