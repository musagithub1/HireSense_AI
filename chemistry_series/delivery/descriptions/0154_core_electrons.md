...
This short chemistry explainer answers: **How does core electrons work?**

Core electrons becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand core electrons by linking structure to observable behavior.
