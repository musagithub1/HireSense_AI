...
This short chemistry explainer answers: **How does paramagnetism work?**

Paramagnetism becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand paramagnetism by linking structure to observable behavior.
