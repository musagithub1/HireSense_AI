...
This short chemistry explainer answers: **How does diamagnetism work?**

Diamagnetism becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand diamagnetism by linking structure to observable behavior.
