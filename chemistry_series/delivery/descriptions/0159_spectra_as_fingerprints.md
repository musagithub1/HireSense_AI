...
This short chemistry explainer answers: **How does spectra as fingerprints work?**

Spectra as fingerprints becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand spectra as fingerprints by linking structure to observable behavior.
