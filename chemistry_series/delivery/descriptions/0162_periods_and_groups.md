...
This short chemistry explainer answers: **How does periods and groups work?**

Periods and groups becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand periods and groups by linking structure to observable behavior.
