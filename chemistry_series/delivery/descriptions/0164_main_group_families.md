...
This short chemistry explainer answers: **How does main-group families work?**

Main-group families becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand main-group families by linking structure to observable behavior.
