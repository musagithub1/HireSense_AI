...
This short chemistry explainer answers: **How does alkali metals work?**

Alkali metals becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand alkali metals by linking structure to observable behavior.
