...
This short chemistry explainer answers: **How does chalcogens work?**

Chalcogens becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand chalcogens by linking structure to observable behavior.
