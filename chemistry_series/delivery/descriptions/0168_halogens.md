...
This short chemistry explainer answers: **How does halogens work?**

Halogens becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand halogens by linking structure to observable behavior.
