...
This short chemistry explainer answers: **How does lanthanides work?**

Lanthanides becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand lanthanides by linking structure to observable behavior.
