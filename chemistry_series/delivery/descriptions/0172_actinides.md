...
This short chemistry explainer answers: **How does actinides work?**

Actinides becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand actinides by linking structure to observable behavior.
