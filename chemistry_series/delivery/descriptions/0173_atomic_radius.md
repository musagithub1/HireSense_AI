...
This short chemistry explainer answers: **How does atomic radius work?**

Atomic radius becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand atomic radius by linking structure to observable behavior.
