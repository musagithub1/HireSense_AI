...
This short chemistry explainer answers: **How does ionization energy work?**

Ionization energy becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand ionization energy by linking structure to observable behavior.
