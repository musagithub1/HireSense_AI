...
This short chemistry explainer answers: **How does electron affinity work?**

Electron affinity becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand electron affinity by linking structure to observable behavior.
