...
This short chemistry explainer answers: **How does metallic bonding work?**

Metallic bonding becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand metallic bonding by linking structure to observable behavior.
