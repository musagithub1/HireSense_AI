...
This short chemistry explainer answers: **How does octahedral geometry work?**

Octahedral geometry becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand octahedral geometry by linking structure to observable behavior.
