...
This short chemistry explainer answers: **How does ion-dipole forces work?**

Ion-dipole forces becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand ion-dipole forces by linking structure to observable behavior.
