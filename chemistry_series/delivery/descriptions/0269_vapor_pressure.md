...
This short chemistry explainer answers: **How does vapor pressure work?**

Vapor pressure becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand vapor pressure by linking structure to observable behavior.
