...
This short chemistry explainer answers: **How does volatility work?**

Volatility becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand volatility by linking structure to observable behavior.
