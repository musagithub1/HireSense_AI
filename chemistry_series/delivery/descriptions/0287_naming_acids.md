...
This short chemistry explainer answers: **How does naming acids work?**

Naming acids becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand naming acids by linking structure to observable behavior.
