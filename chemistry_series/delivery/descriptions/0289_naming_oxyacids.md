...
This short chemistry explainer answers: **How does naming oxyacids work?**

Naming oxyacids becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand naming oxyacids by linking structure to observable behavior.
