...
This short chemistry explainer answers: **How does naming bases work?**

Naming bases becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand naming bases by linking structure to observable behavior.
