...
This short chemistry explainer answers: **How does naming hydrates work?**

Naming hydrates becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand naming hydrates by linking structure to observable behavior.
