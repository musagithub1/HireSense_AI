...
This short chemistry explainer answers: **How does naming simple hydrocarbons work?**

Naming simple hydrocarbons becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand naming simple hydrocarbons by linking structure to observable behavior.
