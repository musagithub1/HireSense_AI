...
This short chemistry explainer answers: **How does naming alkanes work?**

Naming alkanes becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand naming alkanes by linking structure to observable behavior.
