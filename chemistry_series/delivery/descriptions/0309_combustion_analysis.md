...
This short chemistry explainer answers: **How does combustion analysis work?**

Combustion analysis becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand combustion analysis by linking structure to observable behavior.
