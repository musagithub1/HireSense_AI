...
This short chemistry explainer answers: **How does synthesis reactions work?**

Synthesis reactions becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand synthesis reactions by linking structure to observable behavior.
