...
This short chemistry explainer answers: **How does net ionic equations work?**

Net ionic equations becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand net ionic equations by linking structure to observable behavior.
