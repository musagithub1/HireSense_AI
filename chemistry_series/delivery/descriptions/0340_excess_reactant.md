...
This short chemistry explainer answers: **How does excess reactant work?**

Excess reactant becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand excess reactant by linking structure to observable behavior.
