...
This short chemistry explainer answers: **How does percent yield work?**

Percent yield becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand percent yield by linking structure to observable behavior.
