...
This short chemistry explainer answers: **How does oxidation numbers work?**

Oxidation numbers becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand oxidation numbers by linking structure to observable behavior.
