...
This short chemistry explainer answers: **How does oxidation versus reduction work?**

Oxidation versus reduction becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand oxidation versus reduction by linking structure to observable behavior.
