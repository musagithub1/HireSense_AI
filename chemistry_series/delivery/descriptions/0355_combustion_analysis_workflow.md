...
This short chemistry explainer answers: **How does combustion analysis workflow work?**

Combustion analysis workflow becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand combustion analysis workflow by linking structure to observable behavior.
