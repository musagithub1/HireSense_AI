...
This short chemistry explainer answers: **How does what a solution is work?**

What a solution is becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand what a solution is by linking structure to observable behavior.
