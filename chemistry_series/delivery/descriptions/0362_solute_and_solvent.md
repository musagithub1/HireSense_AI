...
This short chemistry explainer answers: **How does solute and solvent work?**

Solute and solvent becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand solute and solvent by linking structure to observable behavior.
