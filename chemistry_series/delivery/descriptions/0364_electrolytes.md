...
This short chemistry explainer answers: **How does electrolytes work?**

Electrolytes becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand electrolytes by linking structure to observable behavior.
