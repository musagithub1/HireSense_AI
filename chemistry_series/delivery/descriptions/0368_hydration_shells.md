...
This short chemistry explainer answers: **How does hydration shells work?**

Hydration shells becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand hydration shells by linking structure to observable behavior.
