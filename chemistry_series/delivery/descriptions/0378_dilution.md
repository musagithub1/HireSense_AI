...
This short chemistry explainer answers: **How does dilution work?**

Dilution becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand dilution by linking structure to observable behavior.
