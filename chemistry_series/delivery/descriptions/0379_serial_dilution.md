...
This short chemistry explainer answers: **How does serial dilution work?**

Serial dilution becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand serial dilution by linking structure to observable behavior.
