...
This short chemistry explainer answers: **How does gas solubility work?**

Gas solubility becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand gas solubility by linking structure to observable behavior.
