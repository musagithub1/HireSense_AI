...
This short chemistry explainer answers: **How does manometers work?**

Manometers becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand manometers by linking structure to observable behavior.
