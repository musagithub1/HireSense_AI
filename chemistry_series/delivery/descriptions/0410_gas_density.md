...
This short chemistry explainer answers: **How does gas density work?**

Gas density becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand gas density by linking structure to observable behavior.
