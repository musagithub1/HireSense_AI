...
This short chemistry explainer answers: **How does molar mass of a gas work?**

Molar mass of a gas becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand molar mass of a gas by linking structure to observable behavior.
