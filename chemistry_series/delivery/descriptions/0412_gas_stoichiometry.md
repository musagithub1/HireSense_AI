...
This short chemistry explainer answers: **How does gas stoichiometry work?**

Gas stoichiometry becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand gas stoichiometry by linking structure to observable behavior.
