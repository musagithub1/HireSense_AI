...
This short chemistry explainer answers: **How does gas diffusion work?**

Gas diffusion becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand gas diffusion by linking structure to observable behavior.
