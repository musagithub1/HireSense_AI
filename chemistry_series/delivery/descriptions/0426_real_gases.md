...
This short chemistry explainer answers: **How does real gases work?**

Real gases becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand real gases by linking structure to observable behavior.
