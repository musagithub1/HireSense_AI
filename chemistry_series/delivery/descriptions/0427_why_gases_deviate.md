...
This short chemistry explainer answers: **How does why gases deviate work?**

Why gases deviate becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand why gases deviate by linking structure to observable behavior.
