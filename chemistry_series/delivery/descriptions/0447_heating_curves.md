...
This short chemistry explainer answers: **How does heating curves work?**

Heating curves becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand heating curves by linking structure to observable behavior.
