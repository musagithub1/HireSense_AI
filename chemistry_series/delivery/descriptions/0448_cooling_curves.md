...
This short chemistry explainer answers: **How does cooling curves work?**

Cooling curves becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand cooling curves by linking structure to observable behavior.
