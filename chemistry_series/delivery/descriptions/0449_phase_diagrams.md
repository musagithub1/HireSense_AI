...
This short chemistry explainer answers: **How does phase diagrams work?**

Phase diagrams becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand phase diagrams by linking structure to observable behavior.
