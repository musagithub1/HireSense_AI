...
This short chemistry explainer answers: **How does fusion curves work?**

Fusion curves becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand fusion curves by linking structure to observable behavior.
