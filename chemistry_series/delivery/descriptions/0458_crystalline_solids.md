...
This short chemistry explainer answers: **How does crystalline solids work?**

Crystalline solids becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand crystalline solids by linking structure to observable behavior.
