...
This short chemistry explainer answers: **How does amorphous solids work?**

Amorphous solids becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand amorphous solids by linking structure to observable behavior.
