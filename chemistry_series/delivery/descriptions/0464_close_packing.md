...
This short chemistry explainer answers: **How does close packing work?**

Close packing becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand close packing by linking structure to observable behavior.
