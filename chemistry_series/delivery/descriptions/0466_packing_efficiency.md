...
This short chemistry explainer answers: **How does packing efficiency work?**

Packing efficiency becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand packing efficiency by linking structure to observable behavior.
