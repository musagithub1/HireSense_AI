...
This short chemistry explainer answers: **How does molecular solids work?**

Molecular solids becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand molecular solids by linking structure to observable behavior.
