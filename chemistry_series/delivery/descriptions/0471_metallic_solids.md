...
This short chemistry explainer answers: **How does metallic solids work?**

Metallic solids becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand metallic solids by linking structure to observable behavior.
