...
This short chemistry explainer answers: **How does defects in crystals work?**

Defects in crystals becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand defects in crystals by linking structure to observable behavior.
