...
This short chemistry explainer answers: **How does polymorphism work?**

Polymorphism becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand polymorphism by linking structure to observable behavior.
