...
This short chemistry explainer answers: **How does internal energy work?**

Internal energy becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand internal energy by linking structure to observable behavior.
