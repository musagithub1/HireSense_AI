...
This short chemistry explainer answers: **How does calorimetry work?**

Calorimetry becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand calorimetry by linking structure to observable behavior.
