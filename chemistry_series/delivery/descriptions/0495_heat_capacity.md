...
This short chemistry explainer answers: **How does heat capacity work?**

Heat capacity becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand heat capacity by linking structure to observable behavior.
