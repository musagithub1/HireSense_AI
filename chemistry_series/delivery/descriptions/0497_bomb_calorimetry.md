...
This short chemistry explainer answers: **How does bomb calorimetry work?**

Bomb calorimetry becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand bomb calorimetry by linking structure to observable behavior.
