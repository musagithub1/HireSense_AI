...
This short chemistry explainer answers: **How does combustion enthalpy work?**

Combustion enthalpy becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand combustion enthalpy by linking structure to observable behavior.
