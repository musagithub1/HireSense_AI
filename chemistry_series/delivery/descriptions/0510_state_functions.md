...
This short chemistry explainer answers: **How does state functions work?**

State functions becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand state functions by linking structure to observable behavior.
