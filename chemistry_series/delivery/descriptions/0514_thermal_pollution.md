...
This short chemistry explainer answers: **How does thermal pollution work?**

Thermal pollution becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand thermal pollution by linking structure to observable behavior.
