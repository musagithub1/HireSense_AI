...
This short chemistry explainer answers: **How does energy in batteries work?**

Energy in batteries becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand energy in batteries by linking structure to observable behavior.
