...
This short chemistry explainer answers: **How does microstates work?**

Microstates becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand microstates by linking structure to observable behavior.
