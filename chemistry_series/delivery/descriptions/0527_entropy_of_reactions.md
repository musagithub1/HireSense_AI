...
This short chemistry explainer answers: **How does entropy of reactions work?**

Entropy of reactions becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand entropy of reactions by linking structure to observable behavior.
