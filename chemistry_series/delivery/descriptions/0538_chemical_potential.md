...
This short chemistry explainer answers: **How does chemical potential work?**

Chemical potential becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand chemical potential by linking structure to observable behavior.
