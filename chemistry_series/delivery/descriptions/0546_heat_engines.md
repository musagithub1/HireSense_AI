...
This short chemistry explainer answers: **How does heat engines work?**

Heat engines becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand heat engines by linking structure to observable behavior.
