...
This short chemistry explainer answers: **How does reaction rate work?**

Reaction rate becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand reaction rate by linking structure to observable behavior.
