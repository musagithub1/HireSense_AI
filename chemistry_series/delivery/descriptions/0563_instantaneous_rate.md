...
This short chemistry explainer answers: **How does instantaneous rate work?**

Instantaneous rate becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand instantaneous rate by linking structure to observable behavior.
