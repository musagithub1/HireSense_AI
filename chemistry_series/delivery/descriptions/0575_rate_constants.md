...
This short chemistry explainer answers: **How does rate constants work?**

Rate constants becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand rate constants by linking structure to observable behavior.
