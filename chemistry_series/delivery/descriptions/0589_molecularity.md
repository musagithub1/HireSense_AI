...
This short chemistry explainer answers: **How does molecularity work?**

Molecularity becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand molecularity by linking structure to observable behavior.
