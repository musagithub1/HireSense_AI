...
This short chemistry explainer answers: **How does intermediates work?**

Intermediates becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand intermediates by linking structure to observable behavior.
