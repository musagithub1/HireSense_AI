...
This short chemistry explainer answers: **How does surface area and rate work?**

Surface area and rate becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand surface area and rate by linking structure to observable behavior.
