...
This short chemistry explainer answers: **How does ice tables work?**

ICE tables becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand ice tables by linking structure to observable behavior.
