...
This short chemistry explainer answers: **How does amphiprotic species work?**

Amphiprotic species becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand amphiprotic species by linking structure to observable behavior.
