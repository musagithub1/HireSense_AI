...
This short chemistry explainer answers: **How does poh work?**

pOH becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand poh by linking structure to observable behavior.
