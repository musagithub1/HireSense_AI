...
This short chemistry explainer answers: **How does base strength and structure work?**

Base strength and structure becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand base strength and structure by linking structure to observable behavior.
