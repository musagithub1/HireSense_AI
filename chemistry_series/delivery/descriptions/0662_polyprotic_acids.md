...
This short chemistry explainer answers: **How does polyprotic acids work?**

Polyprotic acids becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand polyprotic acids by linking structure to observable behavior.
