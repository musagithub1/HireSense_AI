...
This short chemistry explainer answers: **How does indicators work?**

Indicators becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand indicators by linking structure to observable behavior.
