...
This short chemistry explainer answers: **How does ph and solubility work?**

pH and solubility becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand ph and solubility by linking structure to observable behavior.
