...
This short chemistry explainer answers: **How does chelation work?**

Chelation becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand chelation by linking structure to observable behavior.
