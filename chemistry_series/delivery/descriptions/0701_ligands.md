...
This short chemistry explainer answers: **How does ligands work?**

Ligands becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand ligands by linking structure to observable behavior.
