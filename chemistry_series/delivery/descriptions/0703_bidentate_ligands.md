...
This short chemistry explainer answers: **How does bidentate ligands work?**

Bidentate ligands becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand bidentate ligands by linking structure to observable behavior.
