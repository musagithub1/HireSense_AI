...
This short chemistry explainer answers: **How does polydentate ligands work?**

Polydentate ligands becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand polydentate ligands by linking structure to observable behavior.
