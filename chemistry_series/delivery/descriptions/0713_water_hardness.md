...
This short chemistry explainer answers: **How does water hardness work?**

Water hardness becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand water hardness by linking structure to observable behavior.
