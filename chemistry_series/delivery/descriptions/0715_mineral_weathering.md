...
This short chemistry explainer answers: **How does mineral weathering work?**

Mineral weathering becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand mineral weathering by linking structure to observable behavior.
