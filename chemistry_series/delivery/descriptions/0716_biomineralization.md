...
This short chemistry explainer answers: **How does biomineralization work?**

Biomineralization becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand biomineralization by linking structure to observable behavior.
