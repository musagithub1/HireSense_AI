...
This short chemistry explainer answers: **How does voltaic cells work?**

Voltaic cells becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand voltaic cells by linking structure to observable behavior.
