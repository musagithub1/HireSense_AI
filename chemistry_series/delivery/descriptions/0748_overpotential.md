...
This short chemistry explainer answers: **How does overpotential work?**

Overpotential becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand overpotential by linking structure to observable behavior.
