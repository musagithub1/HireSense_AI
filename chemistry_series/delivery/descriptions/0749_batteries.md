...
This short chemistry explainer answers: **How does batteries work?**

Batteries becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand batteries by linking structure to observable behavior.
