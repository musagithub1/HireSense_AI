...
This short chemistry explainer answers: **How does alkaline batteries work?**

Alkaline batteries becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand alkaline batteries by linking structure to observable behavior.
