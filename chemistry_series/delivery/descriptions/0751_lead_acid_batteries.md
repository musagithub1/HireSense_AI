...
This short chemistry explainer answers: **How does lead-acid batteries work?**

Lead-acid batteries becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand lead-acid batteries by linking structure to observable behavior.
