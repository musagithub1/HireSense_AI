...
This short chemistry explainer answers: **How does cathodic protection work?**

Cathodic protection becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand cathodic protection by linking structure to observable behavior.
