...
This short chemistry explainer answers: **How does hydrides work?**

Hydrides becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand hydrides by linking structure to observable behavior.
