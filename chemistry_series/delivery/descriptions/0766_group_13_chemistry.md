...
This short chemistry explainer answers: **How does group 13 chemistry work?**

Group 13 chemistry becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand group 13 chemistry by linking structure to observable behavior.
