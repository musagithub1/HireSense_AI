...
This short chemistry explainer answers: **How does aluminum chemistry work?**

Aluminum chemistry becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand aluminum chemistry by linking structure to observable behavior.
