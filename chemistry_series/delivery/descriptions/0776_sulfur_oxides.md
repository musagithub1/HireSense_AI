...
This short chemistry explainer answers: **How does sulfur oxides work?**

Sulfur oxides becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand sulfur oxides by linking structure to observable behavior.
