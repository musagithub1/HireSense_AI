...
This short chemistry explainer answers: **How does ligand substitution work?**

Ligand substitution becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand ligand substitution by linking structure to observable behavior.
