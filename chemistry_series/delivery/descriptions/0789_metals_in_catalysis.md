...
This short chemistry explainer answers: **How does metals in catalysis work?**

Metals in catalysis becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand metals in catalysis by linking structure to observable behavior.
