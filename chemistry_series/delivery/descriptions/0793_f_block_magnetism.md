...
This short chemistry explainer answers: **How does f-block magnetism work?**

f-block magnetism becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand f-block magnetism by linking structure to observable behavior.
