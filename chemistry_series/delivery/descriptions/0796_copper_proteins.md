...
This short chemistry explainer answers: **How does copper proteins work?**

Copper proteins becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand copper proteins by linking structure to observable behavior.
