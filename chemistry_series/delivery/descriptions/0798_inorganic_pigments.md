...
This short chemistry explainer answers: **How does inorganic pigments work?**

Inorganic pigments becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand inorganic pigments by linking structure to observable behavior.
