...
This short chemistry explainer answers: **How does sp carbon work?**

sp carbon becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand sp carbon by linking structure to observable behavior.
