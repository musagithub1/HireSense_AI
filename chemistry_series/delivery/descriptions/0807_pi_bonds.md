...
This short chemistry explainer answers: **How does pi bonds work?**

Pi bonds becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand pi bonds by linking structure to observable behavior.
