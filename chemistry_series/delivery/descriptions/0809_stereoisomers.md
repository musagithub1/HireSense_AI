...
This short chemistry explainer answers: **How does stereoisomers work?**

Stereoisomers becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand stereoisomers by linking structure to observable behavior.
