...
This short chemistry explainer answers: **How does conformations work?**

Conformations becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand conformations by linking structure to observable behavior.
