...
This short chemistry explainer answers: **How does cis-trans isomerism work?**

Cis-trans isomerism becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand cis-trans isomerism by linking structure to observable behavior.
