...
This short chemistry explainer answers: **How does chirality work?**

Chirality becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand chirality by linking structure to observable behavior.
