...
This short chemistry explainer answers: **How does enantiomers work?**

Enantiomers becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand enantiomers by linking structure to observable behavior.
