...
This short chemistry explainer answers: **How does diastereomers work?**

Diastereomers becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand diastereomers by linking structure to observable behavior.
