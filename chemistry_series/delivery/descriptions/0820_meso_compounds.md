...
This short chemistry explainer answers: **How does meso compounds work?**

Meso compounds becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand meso compounds by linking structure to observable behavior.
