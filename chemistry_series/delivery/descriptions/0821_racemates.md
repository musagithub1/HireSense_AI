...
This short chemistry explainer answers: **How does racemates work?**

Racemates becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand racemates by linking structure to observable behavior.
