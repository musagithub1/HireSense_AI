...
This short chemistry explainer answers: **How does electrophiles work?**

Electrophiles becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand electrophiles by linking structure to observable behavior.
