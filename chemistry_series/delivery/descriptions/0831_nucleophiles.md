...
This short chemistry explainer answers: **How does nucleophiles work?**

Nucleophiles becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand nucleophiles by linking structure to observable behavior.
