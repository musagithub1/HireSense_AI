...
This short chemistry explainer answers: **How does leaving groups work?**

Leaving groups becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand leaving groups by linking structure to observable behavior.
