...
This short chemistry explainer answers: **How does organic oxidation states work?**

Organic oxidation states becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand organic oxidation states by linking structure to observable behavior.
