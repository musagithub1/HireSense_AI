...
This short chemistry explainer answers: **How does alkane radical halogenation work?**

Alkane radical halogenation becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand alkane radical halogenation by linking structure to observable behavior.
