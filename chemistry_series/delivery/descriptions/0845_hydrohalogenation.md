...
This short chemistry explainer answers: **How does hydrohalogenation work?**

Hydrohalogenation becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand hydrohalogenation by linking structure to observable behavior.
