...
This short chemistry explainer answers: **How does markovnikov's rule work?**

Markovnikov's rule becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand markovnikov's rule by linking structure to observable behavior.
