...
This short chemistry explainer answers: **How does alkyne additions work?**

Alkyne additions becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand alkyne additions by linking structure to observable behavior.
