...
This short chemistry explainer answers: **How does sn2 mechanism work?**

SN2 mechanism becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand sn2 mechanism by linking structure to observable behavior.
