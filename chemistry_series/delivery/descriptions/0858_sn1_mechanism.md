...
This short chemistry explainer answers: **How does sn1 mechanism work?**

SN1 mechanism becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand sn1 mechanism by linking structure to observable behavior.
