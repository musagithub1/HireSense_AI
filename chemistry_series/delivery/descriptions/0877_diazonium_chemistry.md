...
This short chemistry explainer answers: **How does diazonium chemistry work?**

Diazonium chemistry becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand diazonium chemistry by linking structure to observable behavior.
