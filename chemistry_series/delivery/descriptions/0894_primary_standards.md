...
This short chemistry explainer answers: **How does primary standards work?**

Primary standards becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand primary standards by linking structure to observable behavior.
