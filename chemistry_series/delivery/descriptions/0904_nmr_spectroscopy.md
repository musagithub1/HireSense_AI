...
This short chemistry explainer answers: **How does nmr spectroscopy work?**

NMR spectroscopy becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand nmr spectroscopy by linking structure to observable behavior.
