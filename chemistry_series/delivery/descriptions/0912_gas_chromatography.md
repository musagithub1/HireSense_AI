...
This short chemistry explainer answers: **How does gas chromatography work?**

Gas chromatography becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand gas chromatography by linking structure to observable behavior.
