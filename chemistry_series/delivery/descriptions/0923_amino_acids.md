...
This short chemistry explainer answers: **How does amino acids work?**

Amino acids becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand amino acids by linking structure to observable behavior.
