...
This short chemistry explainer answers: **How does zwitterions work?**

Zwitterions becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand zwitterions by linking structure to observable behavior.
