...
This short chemistry explainer answers: **How does enzyme catalysis work?**

Enzyme catalysis becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand enzyme catalysis by linking structure to observable behavior.
