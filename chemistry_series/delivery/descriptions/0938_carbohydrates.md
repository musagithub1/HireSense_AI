...
This short chemistry explainer answers: **How does carbohydrates work?**

Carbohydrates becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand carbohydrates by linking structure to observable behavior.
