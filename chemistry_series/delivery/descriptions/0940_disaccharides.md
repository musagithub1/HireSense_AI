...
This short chemistry explainer answers: **How does disaccharides work?**

Disaccharides becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand disaccharides by linking structure to observable behavior.
