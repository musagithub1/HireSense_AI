...
This short chemistry explainer answers: **How does photosynthesis chemistry work?**

Photosynthesis chemistry becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand photosynthesis chemistry by linking structure to observable behavior.
