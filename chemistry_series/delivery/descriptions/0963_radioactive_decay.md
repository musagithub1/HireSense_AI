...
This short chemistry explainer answers: **How does radioactive decay work?**

Radioactive decay becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand radioactive decay by linking structure to observable behavior.
