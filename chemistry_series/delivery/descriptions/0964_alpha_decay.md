...
This short chemistry explainer answers: **How does alpha decay work?**

Alpha decay becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand alpha decay by linking structure to observable behavior.
