...
This short chemistry explainer answers: **How does nuclear equations work?**

Nuclear equations becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand nuclear equations by linking structure to observable behavior.
