...
This short chemistry explainer answers: **How does nuclear fusion work?**

Nuclear fusion becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand nuclear fusion by linking structure to observable behavior.
