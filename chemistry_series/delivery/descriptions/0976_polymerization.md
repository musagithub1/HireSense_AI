...
This short chemistry explainer answers: **How does polymerization work?**

Polymerization becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand polymerization by linking structure to observable behavior.
