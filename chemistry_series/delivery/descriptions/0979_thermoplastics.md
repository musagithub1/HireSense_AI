...
This short chemistry explainer answers: **How does thermoplastics work?**

Thermoplastics becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand thermoplastics by linking structure to observable behavior.
