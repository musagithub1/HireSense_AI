...
This short chemistry explainer answers: **How does elastomers work?**

Elastomers becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand elastomers by linking structure to observable behavior.
