...
This short chemistry explainer answers: **How does composite materials work?**

Composite materials becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand composite materials by linking structure to observable behavior.
