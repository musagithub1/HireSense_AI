...
This short chemistry explainer answers: **How does nanomaterials work?**

Nanomaterials becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand nanomaterials by linking structure to observable behavior.
