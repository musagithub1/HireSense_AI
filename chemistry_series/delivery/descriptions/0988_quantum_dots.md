...
This short chemistry explainer answers: **How does quantum dots work?**

Quantum dots becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand quantum dots by linking structure to observable behavior.
