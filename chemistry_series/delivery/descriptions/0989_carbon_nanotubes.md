...
This short chemistry explainer answers: **How does carbon nanotubes work?**

Carbon nanotubes becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand carbon nanotubes by linking structure to observable behavior.
