...
This short chemistry explainer answers: **How does graphene work?**

Graphene becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand graphene by linking structure to observable behavior.
