...
This short chemistry explainer answers: **How does air pollutants work?**

Air pollutants becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand air pollutants by linking structure to observable behavior.
