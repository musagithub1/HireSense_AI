...
This short chemistry explainer answers: **How does soil chemistry work?**

Soil chemistry becomes clear when we connect particles, structure, and change.

The episode uses continuous animated transformations and captions rather than voiceover.

## Learning outcome
Understand soil chemistry by linking structure to observable behavior.
